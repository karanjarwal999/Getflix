          ...
          <AccordWrapper accordation={Accordation} >
            <div className='QAcard'>
              <div onClick={() => showAccordation(1)}>
                <h3>What is Getflix?</h3>
                <p>+</p>
              </div>
              <p>
                Getflix is a streaming service that offers a wide variety of award-winning TV shows, movies, anime, documentaries and more – on thousands of internet-connected devices. <br /><br />
                You can watch as much as you want, whenever you want, without a single ad – all for one low monthly price. There's always something new to discover, and new TV shows and movies are added every week!</p>
            </div>

            <div className='QAcard'>
              <div onClick={() => showAccordation(2)}>
                <h3>How much does Getflix cost?</h3>
                <p>+</p>
              </div>
              <p>Watch Getflix on your smartphone, tablet, Smart TV, laptop, or streaming device, all for one fixed monthly fee. Plans range from ₹ 149 to ₹ 649 a month. No extra costs, no contracts.</p>
            </div>
            ...
            <div className='QAcard'>
              ...
              <p>Watch anywhere, anytime. Sign in with your Getflix account to watch instantly on the web at Getflix.com from your personal computer or on any internet-connected device that offers the Getflix app, including smart TVs, smartphones, tablets, streaming media players and game consoles. <br /><br />
                You can also download your favourite shows with the iOS, Android, or Windows 10 app. Use downloads to watch while you're on the go and without an internet connection. Take Getflix with you anywhere</p>
            </div>
            <div className='QAcard'>
              ...
              <p>Getflix is flexible. There are no annoying contracts and no commitments. You can easily cancel your account online in two clicks. There are no cancellation fees – start or stop your account anytime.</p>
            </div>
            <div className='QAcard'>
              <div onClick={() => showAccordation(5)}>
                <h3>What can I watch on Getflix?</h3>
                <p>+</p>
              </div>
              <p>Getflix has an extensive library of feature films, documentaries, TV shows, anime, award-winning Getflix originals, and more. Watch as much as you want, anytime you want.</p>
            </div>
            <div className='QAcard'>
              <div onClick={() => showAccordation(6)}>
                <h3>Is Getflix good for kids?</h3>
                <p>+</p>
              </div>
              <p>The Getflix Kids experience is included in your membership to give parents control while kids enjoy family-friendly TV shows and films in their own space. <br /><br />
